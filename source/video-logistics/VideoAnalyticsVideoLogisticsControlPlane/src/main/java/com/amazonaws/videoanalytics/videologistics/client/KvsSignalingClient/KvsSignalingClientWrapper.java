package com.amazonaws.videoanalytics.videologistics.client.KvsSignalingClient;
...
public class KvsSignalingClientWrapper {
    ...
    public List<Source.GuidanceIceServer> getIceServerConfigs(final String channelArn,
        ...
        try {
            ...
            LOG.error(exception.getMessage());
            throw new com.amazonaws.videoanalytics.videologistics.exceptions.InternalServerException(INTERNAL_SERVER_EXCEPTION, exception);
        }
        catch (ResourceNotFoundException exception) {
            throw new com.amazonaws.videoanalytics.videologistics.exceptions.ResourceNotFoundException(String.format(DEVICE_NOT_REGISTERED, deviceId, signalingChannelName));
        }
