package com.amazonaws.videoanalytics.videologistics.client.KvsClient;

import com.amazonaws.videoanalytics.videologistics.exceptions.ValidationException;
...
import static com.amazonaws.videoanalytics.videologistics.exceptions.GuidanceExceptionMessage.DEVICE_NOT_REGISTERED;
import static com.amazonaws.videoanalytics.videologistics.exceptions.GuidanceExceptionMessage.NOT_AUTHORIZED;
import static com.amazonaws.videoanalytics.videologistics.schema.util.ResourceNameConversionUtils.getDeviceIdFromPlaybackSignalingChannelName;
import static com.amazonaws.videoanalytics.videologistics.schema.util.ResourceNameConversionUtils.getPlaybackSignalingChannelNameFromDeviceId;
...
public class KvsClientWrapper {
    ...
    public Map<String, String> getSignalingChannelEndpoint(final String channelArn,
        ...
        try {
            ...
            throw new com.amazonaws.videoanalytics.videologistics.exceptions.AccessDeniedException(exception.getMessage() + NOT_AUTHORIZED);
        }
            ...
            throw new com.amazonaws.videoanalytics.videologistics.exceptions.ResourceNotFoundException(String.format(DEVICE_NOT_REGISTERED, deviceId, signalingChannelName));
        }
    }
    ...
    public String getDataEndpoint(final String streamName) {
        ...
        try {
            ...
            throw new com.amazonaws.videoanalytics.videologistics.exceptions.ResourceNotFoundException(String.format(DEVICE_NOT_REGISTERED, deviceId, streamName));
        }
    }
    ...
    public String getDataEndpointWithApiName(final String streamName, final APIName apiName) {
        ...
        try {
            ...
            throw new com.amazonaws.videoanalytics.videologistics.exceptions.AccessDeniedException(exception.getMessage() + NOT_AUTHORIZED, exception);
        }
        catch (software.amazon.awssdk.services.kinesisvideo.model.ResourceNotFoundException exception) {
            throw new com.amazonaws.videoanalytics.videologistics.exceptions.ResourceNotFoundException(String.format(DEVICE_NOT_REGISTERED, deviceId, streamName));
        }
