...
import static com.amazonaws.videoanalytics.videologistics.utils.AWSVideoAnalyticsServiceLambdaConstants.PROXY_LAMBDA_REQUEST_SESSION_ID_PATH_PARAMETER_KEY;
...
import static com.amazonaws.videoanalytics.videologistics.utils.TestConstants.SHADOW_NAME;
...
public class LambdaProxyUtilsTest {
    ...
    private final Map<String, Object> lambdaProxyRequest = Map.ofEntries(
        entry(PROXY_LAMBDA_REQUEST_PATH_PARAMETERS_KEY, Map.ofEntries(
            entry(PROXY_LAMBDA_REQUEST_SESSION_ID_PATH_PARAMETER_KEY, SESSION_ID)
        )),
    ...
    public void parsePathParameter_WhenValidKey_ReturnsValue() {
        String sessionId = LambdaProxyUtils.parsePathParameter(lambdaProxyRequest, PROXY_LAMBDA_REQUEST_SESSION_ID_PATH_PARAMETER_KEY);
    ...
    public void parseRequestBody_WhenInvalidJson_ThrowsException() {
        Map<String, Object> invalidRequest = Map.ofEntries(
            ...
            entry(PROXY_LAMBDA_BODY_KEY, "{invalid json}")
        );
    ...
    public void parseRequestBody_WhenMismatchedSchema_ReturnsObjectWithNullFields() {
        Map<String, Object> mismatchedRequest = Map.of(
            PROXY_LAMBDA_BODY_KEY, "{\"wrongField\": \"value\"}"
        );
