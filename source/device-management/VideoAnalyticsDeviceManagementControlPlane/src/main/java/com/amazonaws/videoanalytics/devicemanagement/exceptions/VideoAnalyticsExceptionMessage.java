...
public class VideoAnalyticsExceptionMessage {
    ...
    public static final String RESOURCE_ALREADY_EXISTS_EXCEPTION = "Video Analytics resource you are trying to create " +
    ...
    public static final String RESOURCE_NOT_FOUND_EXCEPTION = "Video Analytics resource you are trying to get does not exist.";
