...
export const FORWARDING_RULES_ACCESS_LOGS_BUCKET_NAME = 'videoanalytics-fwd-rules-access-logs';
export const FORWARDING_RULES_SQS_QUEUE_NAME = 'aws-ip-videoanalytics-VLControlPlane-forwardingRulesQueue';
...
export const UPDATED_TIMESTAMP = '$.exportResult.Payload.newLastProcessedTimestamp';
