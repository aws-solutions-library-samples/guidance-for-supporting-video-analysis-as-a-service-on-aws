...
import { Duration, Fn, RemovalPolicy, StackProps } from 'aws-cdk-lib';
import {
...
export class ForwardingRulesStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: ForwardingRulesProps) {
    ...
    const forwardingRulesKmsKey = new Key(this, `${FORWARDING_RULES_SQS_QUEUE_NAME}-kmsKey`, {
    ...
    const deadLetterQueue = new Queue(this, `${FORWARDING_RULES_SQS_QUEUE_NAME}-StreamDLQ`, {
    ...
    const lambdaRole = new Role(this, 'DataForwarderLambdaRole', {
      ...
      description: 'Allows lambda to read and delete messages from the SQS queue'
    });
    ...
    this.dataForwarderLambda = new Function(this, 'DataForwarderLambda', {
      ...
      description: 'Lambda responsible for forwarding data in accordance with forwarding rules',
