...
export class StartGetDeviceCapabilities extends VideoAnalyticsAsyncWorkflowResource {
    ...
    createStepFunction(): void {
        const requestCapabilitiesLambda = new Function(this, 'RequestCapabilitiesLambda', {
        ...
        const failGetCapabilitiesLambda = new Function(this, 'FailGetCapabilitiesLambda', {
            //TODO: Update this if any changes are made to the lambda handler path or asset built jar location
            code: Code.fromAsset(`${LAMBDA_ASSET_PATH_TO_DEVICE_MANAGEMENT}`),
        ...
        const requestCapabilitiesState = new LambdaInvoke(this, 'RequestCapabilities', {
        ...
        const failGetCapabilitiesState = new LambdaInvoke(this, 'FailGetCapabilities', {
        ...
        requestCapabilitiesState.addCatch(failGetCapabilitiesState, { resultPath: RESULT_PATH_ERROR });
        getCapabilitiesState.addCatch(failGetCapabilitiesState, { resultPath: RESULT_PATH_ERROR });

        failGetCapabilitiesState.next(failState);
        requestCapabilitiesState.next(getCapabilitiesState).next(successState);

        this.stateMachine = new StateMachine(this, 'GetDeviceCapabilitiesStateMachine', {
