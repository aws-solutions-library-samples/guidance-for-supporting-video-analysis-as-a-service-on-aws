  ...
  createStepFunction(): void {
    ...
    const attachNotificationPermissionToDeviceCertLambda = new Function(
      ...
      "AttachNotificationPermissionToDeviceCertLambda",
      {
        ...
        handler:
          "com.amazon.awsvideoanalyticsdmcontrolplane.workflow.createdevicenotif.AttachNotificationPermissionToDeviceCertHandler::handleRequest",
        memorySize: 2048,
        role: this.role,
        environment: {
        ...
        logGroup: new LogGroup(
          this,
          "AttachNotificationPermissionToDeviceCertLambdaLogGroup",
          {
            retention: RetentionDays.TEN_YEARS,
            logGroupName:
              "/aws/lambda/AttachNotificationPermissionToDeviceCertLambda",
          }
        ),
      }
    );
    ...
    const addNotificationTopicToShadowLambda = new Function(
      ...
      "AddNotificationTopicToShadowLambda",
      {
        ...
        handler:
          "com.amazon.awsvideoanalyticsdmcontrolplane.workflow.createdevicenotif.AddNotificationTopicToShadowHandler::handleRequest",
        memorySize: 2048,
        role: this.role,
        environment: {
          ACCOUNT_ID: this.account,
        ...
        logGroup: new LogGroup(
          this,
          "AddNotificationTopicToShadowLambdaLogGroup",
          {
            retention: RetentionDays.TEN_YEARS,
    ...
    const updateCreateDeviceNotificationStatusStateLambda = new Function(
      ...
      "UpdateCreateDeviceNotificationStatusLambda",
      {
        ...
        //TODO: Update this lambda to use the correct code path relative to the package path
        handler:
          "com.amazon.awsvideoanalyticsdmcontrolplane.workflow.createdevicenotif.UpdateCreateDeviceNotificationStatusStateHandler::handleRequest",
        memorySize: 2048,
        role: this.role,
        environment: {
          ACCOUNT_ID: this.account,
        ...
        logGroup: new LogGroup(
          this,
          "UpdateCreateDeviceNotificationStatusLambdaLogGroup",
          {
            retention: RetentionDays.TEN_YEARS,
            logGroupName:
              "/aws/lambda/UpdateCreateDeviceNotificationStatusLambda",
          }
        ),
      }
    );
    ...
    const failCreateDeviceNotificationStatusStateLambda = new Function(
      ...
      "FailCreateDeviceNotificationStatusLambda",
      {
        ...
        //TODO: Update this lambda to use the correct code path relative to the package path
        handler:
          "com.amazon.awsvideoanalyticsdmcontrolplane.workflow.createdevicenotif.FailCreateDeviceNotificationStatusStateHandler::handleRequest",
        memorySize: 2048,
        role: this.role,
        environment: {
          ACCOUNT_ID: this.account,
        ...
        logGroup: new LogGroup(
          this,
          "FailCreateDeviceNotificationStatusLambdaLogGroup",
          {
            retention: RetentionDays.TEN_YEARS,
            logGroupName:
              "/aws/lambda/FailCreateDeviceNotificationStatusLambda",
          }
        ),
      }
    );
    ...
    attachNotificationPermissionToDeviceCertState.next(
      addNotificationTopicToShadowState
    );
    ...
    addNotificationTopicToShadowState.next(
      updateCreateDeviceNotificationStatusState
    );
    ...
    addNotificationTopicToShadowState.addCatch(
      failCreateDeviceNotificationStatusState,
      {
        resultPath: RESULT_PATH_ERROR,
      }
    ...
    updateCreateDeviceNotificationStatusState.addCatch(
      failCreateDeviceNotificationStatusState,
      {
        resultPath: RESULT_PATH_ERROR,
      }
