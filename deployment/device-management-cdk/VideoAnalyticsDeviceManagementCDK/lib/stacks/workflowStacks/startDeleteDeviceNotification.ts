  ...
  createStepFunction(): void {
    ...
    const detachNotificationPermissionFromDeviceCertLambda = new Function(
      ...
      "DetachNotificationPermissionFromDeviceCertLambda",
      {
        ...
        handler: `${DM_WORKFLOW_JAVA_PATH_PREFIX}deletedevicenotif.DetachNotificationPermissionFromDeviceCertHandler::handleRequest`,
        ...
        logGroup: new LogGroup(
          this,
          "DetachNotificationPermissionFromDeviceCertLambdaLogGroup",
          {
    ...
    const removeNotificationTopicFromShadowLambda = new Function(
      ...
      "RemoveNotificationTopicFromShadowLambda",
      {
        ...
        runtime: LAMBDA_RUNTIME,
        handler: `${DM_WORKFLOW_JAVA_PATH_PREFIX}deletedevicenotif.RemoveNotificationTopicFromShadowHandler::handleRequest`,
        memorySize: LAMBDA_MEMORY_SIZE_KB,
        role: this.role,
        environment: {
          AccountId: this.account.toString(),
        ...
        logGroup: new LogGroup(
          this,
          "RemoveNotificationTopicFromShadowLambdaLogGroup",
          {
            retention: RetentionDays.TEN_YEARS,
    ...
    const updateDeleteDeviceNotificationStatusStateLambda = new Function(
      ...
      "UpdateDeleteDeviceNotificationStatusLambda",
      {
        ...
        runtime: LAMBDA_RUNTIME,
        handler: `${DM_WORKFLOW_JAVA_PATH_PREFIX}deletedevicenotif.UpdateDeleteDeviceNotificationStatusStateHandler::handleRequest`,
        memorySize: LAMBDA_MEMORY_SIZE_KB,
        role: this.role,
        environment: {
          AccountId: this.account.toString(),
        ...
        logGroup: new LogGroup(
          this,
          "UpdateDeleteDeviceNotificationStatusLambdaLogGroup",
          {
            retention: RetentionDays.TEN_YEARS,
    ...
    const failDeleteDeviceNotificationStatusStateLambda = new Function(
      ...
      "FailDeleteDeviceNotificationStatusLambda",
      {
        ...
        logGroup: new LogGroup(
          this,
          "FailDeleteDeviceNotificationStatusLambdaLogGroup",
          {
            retention: RetentionDays.TEN_YEARS,
    ...
    detachNotificationPermissionFromDeviceCertState.next(
      removeNotificationTopicFromShadowState
    );
    ...
    removeNotificationTopicFromShadowState.next(
      updateDeleteDeviceNotificationStatusState
    );
    ...
    removeNotificationTopicFromShadowState.addCatch(
      failDeleteDeviceNotificationStatusState,
      {
        resultPath: RESULT_PATH_ERROR,
      }
    ...
    updateDeleteDeviceNotificationStatusState.addCatch(
      failDeleteDeviceNotificationStatusState,
      {
        resultPath: RESULT_PATH_ERROR,
      }
