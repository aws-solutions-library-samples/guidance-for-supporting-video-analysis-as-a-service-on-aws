...
export class StartUpdateDevice extends VideoAnalyticsAsyncWorkflowResource {
  ...
  createStepFunction(): void {
    ...
    const determineUpdateTypeLambda = new Function(this, 'DetermineUpdateTypeLambda', {
      ...
      handler:
        `${DM_WORKFLOW_JAVA_PATH_PREFIX}update.DetermineUpdateTypeHandler::handleRequest`,
    ...
    const determineCommandTypeLambda = new Function(this, 'DetermineCommandTypeLambda', {
      //TODO: Update this if any changes are made to the lambda handler path or asset built jar location
      code: Code.fromAsset(`${LAMBDA_ASSET_PATH_TO_DEVICE_MANAGEMENT}`),
      description:
      ...
      runtime: LAMBDA_RUNTIME,
      handler:
        `${DM_WORKFLOW_JAVA_PATH_PREFIX}update.DetermineCommandTypeHandler::handleRequest`,
      //TODO: Update this if any changes are made to the lambda handler path
      memorySize: LAMBDA_MEMORY_SIZE_KB,
      role: this.role,
      environment: {
    ...
    const createDownloadFileIotJobLambda = new Function(this, 'CreateDownloadFileIotJobLambda', {
      //TODO: Update this if any changes are made to the lambda handler path or asset built jar location
      code: Code.fromAsset(`${LAMBDA_ASSET_PATH_TO_DEVICE_MANAGEMENT}`),
      description: 'Lambda responsible for creating an IoT Job to download a file.',
      runtime: LAMBDA_RUNTIME,
      handler:
        `${DM_WORKFLOW_JAVA_PATH_PREFIX}update.CreateDownloadFileIotJobHandler::handleRequest`,
      //TODO: Update this if any changes are made to the lambda handler path
      memorySize: LAMBDA_MEMORY_SIZE_KB,
      role: this.role,
      environment: {
    ...
    const checkIotDownloadJobStatusLambda = new Function(this, 'CheckIotDownloadJobStatusLambda', {
      //TODO: Update this if any changes are made to the lambda handler path or asset built jar location
      code: Code.fromAsset(`${LAMBDA_ASSET_PATH_TO_DEVICE_MANAGEMENT}`),
      description: 'Lambda responsible for checking IoT Job status for the download file job.',
      runtime: LAMBDA_RUNTIME,
      handler:
        `${DM_WORKFLOW_JAVA_PATH_PREFIX}update.CheckIotDownloadJobStatusHandler::handleRequest`,
      //TODO: Update this if any changes are made to the lambda handler path
      memorySize: LAMBDA_MEMORY_SIZE_KB,
      role: this.role,
      environment: {
    ...
    const createInstallApplicationIotJobLambda = new Function(
      ...
      'CreateInstallApplicationIotJobLambda',
      {
        ...
        runtime: LAMBDA_RUNTIME,
        handler:
          `${DM_WORKFLOW_JAVA_PATH_PREFIX}update.CreateInstallApplicationIotJobHandler::handleRequest`,
        //TODO: Update this if any changes are made to the lambda handler path
        memorySize: LAMBDA_MEMORY_SIZE_KB,
        role: this.role,
        environment: {
    ...
    const createCommandIotJobLambda = new Function(this, 'CreateCommandIotJobLambda', {
      //TODO: Update this if any changes are made to the lambda handler path or asset built jar location
      code: Code.fromAsset(`${LAMBDA_ASSET_PATH_TO_DEVICE_MANAGEMENT}`),
      description: 'Lambda responsible for creating an IoT Job for a given device command.',
      runtime: LAMBDA_RUNTIME,
      handler:
        `${DM_WORKFLOW_JAVA_PATH_PREFIX}update.CreateCommandIotJobHandler::handleRequest`,
      //TODO: Update this if any changes are made to the lambda handler path
      memorySize: LAMBDA_MEMORY_SIZE_KB,
      role: this.role,
      environment: {
    ...
    const checkIotJobStatusLambda = new Function(this, 'CheckIotJobStatusLambda', {
      //TODO: Update this if any changes are made to the lambda handler path or asset built jar location
      code: Code.fromAsset(`${LAMBDA_ASSET_PATH_TO_DEVICE_MANAGEMENT}`),
      description: 'Lambda responsible for checking IoT Job status.',
      runtime: LAMBDA_RUNTIME,
      handler:
        `${DM_WORKFLOW_JAVA_PATH_PREFIX}update.CheckIotJobStatusHandler::handleRequest`,
      //TODO: Update this if any changes are made to the lambda handler path
      memorySize: LAMBDA_MEMORY_SIZE_KB,
      role: this.role,
      environment: {
    ...
    const publishConfigurationsToShadowLambda = new Function(
      ...
      'PublishConfigurationsToShadowLambda',
      {
        ...
        runtime: LAMBDA_RUNTIME,
        handler:
          `${DM_WORKFLOW_JAVA_PATH_PREFIX}update.PublishConfigurationsToShadowHandler::handleRequest`,
        //TODO: Update this if any changes are made to the lambda handler path
        memorySize: LAMBDA_MEMORY_SIZE_KB,
        role: this.role,
        environment: {
        ...
        timeout: LAMBDA_TIMEOUT_MINUTES,
        logGroup: new LogGroup(this, 'PublishConfigurationsToShadowLambdaLogGroup', {
    ...
    const messageDeviceLambda = new Function(this, 'MessageDeviceLambda', {
      ...
      runtime: LAMBDA_RUNTIME,
      handler:
        `${DM_WORKFLOW_JAVA_PATH_PREFIX}update.MessageDeviceHandler::handleRequest`,
      //TODO: Update this if any changes are made to the lambda handler path
      memorySize: LAMBDA_MEMORY_SIZE_KB,
      role: this.role,
      environment: {
    ...
    const determineDeviceStateLambda = new Function(this, 'DetermineIsDeviceStateLambda', {
      //TODO: Update this if any changes are made to the lambda handler path or asset built jar location
      code: Code.fromAsset(`${LAMBDA_ASSET_PATH_TO_DEVICE_MANAGEMENT}`),
      description:
      ...
      runtime: LAMBDA_RUNTIME,
      handler:
        `${DM_WORKFLOW_JAVA_PATH_PREFIX}update.DetermineDeviceStateHandler::handleRequest`,
      //TODO: Update this if any changes are made to the lambda handler path
      memorySize: LAMBDA_MEMORY_SIZE_KB,
      role: this.role,
      environment: {
    ...
    const updateUpdateStatusStateLambda = new Function(this, 'UpdateUpdateStatusLambda', {
      //TODO: Update this if any changes are made to the lambda handler path or asset built jar location
      code: Code.fromAsset(`${LAMBDA_ASSET_PATH_TO_DEVICE_MANAGEMENT}`),
      description: 'Lambda responsible for updating the state of the Update Device Job',
      runtime: LAMBDA_RUNTIME,
      handler:
        `${DM_WORKFLOW_JAVA_PATH_PREFIX}update.UpdateUpdateStatusStateHandler::handleRequest`,
      //TODO: Update this if any changes are made to the lambda handler path
      memorySize: LAMBDA_MEMORY_SIZE_KB,
      role: this.role,
      environment: {
    ...
    const updateDeviceTypeStateLambda = new Function(this, 'UpdateDeviceTypeLambda', {
      //TODO: Update this if any changes are made to the lambda handler path or asset built jar location
      code: Code.fromAsset(`${LAMBDA_ASSET_PATH_TO_DEVICE_MANAGEMENT}`),
      description: 'Lambda responsible for updating deviceType for deviceTypePayloads.',
      runtime: LAMBDA_RUNTIME,
      handler:
        `${DM_WORKFLOW_JAVA_PATH_PREFIX}update.DeviceTypePayloadHandler::handleRequest`,
      //TODO: Update this if any changes are made to the lambda handler path
      memorySize: LAMBDA_MEMORY_SIZE_KB,
      role: this.role,
      environment: {
      ...
      timeout: LAMBDA_TIMEOUT_MINUTES,
      logGroup: new LogGroup(this, 'UpdateDeviceTypeFromUpdateDeviceLambdaLogGroup', {
        retention: RetentionDays.TEN_YEARS,
    ...
    const publishDeviceStateEventHandlerLambda = new Function(
      ...
      'PublishDeviceStateEventHandlerLambda',
      {
        ...
        runtime: LAMBDA_RUNTIME,
        handler:
          `${DM_WORKFLOW_JAVA_PATH_PREFIX}update.PublishDeviceStateEventHandler::handleRequest`,
        //TODO: Update this if any changes are made to the lambda handler path
        memorySize: LAMBDA_MEMORY_SIZE_KB,
        role: this.role,
        environment: {
        ...
        timeout: LAMBDA_TIMEOUT_MINUTES,
        logGroup: new LogGroup(this, 'PublishDeviceStateEventHandlerLambdaLogGroup', {
          retention: RetentionDays.TEN_YEARS,
    ...
    const createKVSStreamLambda = new Function(this, 'CreateKVSStreamLambda', {
      ...
      runtime: LAMBDA_RUNTIME,
      handler:
        `${DM_WORKFLOW_JAVA_PATH_PREFIX}update.CreateKVSStreamHandler::handleRequest`,
      //TODO: Update this if any changes are made to the lambda handler path
      memorySize: LAMBDA_MEMORY_SIZE_KB,
      role: this.role,
      environment: {
    ...
    const attachKvsAccessToCertLambda = new Function(this, 'AttachKvsAccessToCertLambda', {
      //TODO: Update this if any changes are made to the lambda handler path or asset built jar location
      code: Code.fromAsset(`${LAMBDA_ASSET_PATH_TO_DEVICE_MANAGEMENT}`),
      description: 'Lambda responsible for attaching cert to KVS Roles policy.',
      runtime: LAMBDA_RUNTIME,
      handler:
        `${DM_WORKFLOW_JAVA_PATH_PREFIX}update.AttachKvsAccessToCertHandler::handleRequest`,
      //TODO: Update this if any changes are made to the lambda handler path
      memorySize: LAMBDA_MEMORY_SIZE_KB,
      role: this.role,
      environment: {
    ...
    const detachKvsAccessToCertLambda = new Function(this, 'DetachKvsAccessToCertLambda', {
      //TODO: Update this if any changes are made to the lambda handler path or asset built jar location
      code: Code.fromAsset(`${LAMBDA_ASSET_PATH_TO_DEVICE_MANAGEMENT}`),
      description: 'Lambda responsible for detaching cert to KVS Roles policy.',
      runtime: LAMBDA_RUNTIME,
      handler:
        `${DM_WORKFLOW_JAVA_PATH_PREFIX}update.DetachKvsAccessFromCertHandler::handleRequest`,
      //TODO: Update this if any changes are made to the lambda handler path
      memorySize: LAMBDA_MEMORY_SIZE_KB,
      role: this.role,
      environment: {
    ...
    const fvlWorkflowCheckerLambda = new Function(this, 'FVLWorkflowCheckerLambda', {
      //TODO: Update this if any changes are made to the lambda handler path or asset built jar location
      code: Code.fromAsset(`${LAMBDA_ASSET_PATH_TO_DEVICE_MANAGEMENT}`),
      description:
      ...
      runtime: LAMBDA_RUNTIME,
      handler:
        `${DM_WORKFLOW_JAVA_PATH_PREFIX}update.FVLWorkflowCheckerHandler::handleRequest`,
      //TODO: Update this if any changes are made to the lambda handler path
      memorySize: LAMBDA_MEMORY_SIZE_KB,
      role: this.role,
      environment: {
    ...
    const updateDeviceGroupLambda = new Function(this, 'UpdateDeviceGroupLambda', {
      //TODO: Update this if any changes are made to the lambda handler path or asset built jar location
      code: Code.fromAsset(`${LAMBDA_ASSET_PATH_TO_DEVICE_MANAGEMENT}`),
      description:
      ...
      runtime: LAMBDA_RUNTIME,
      handler:
        `${DM_WORKFLOW_JAVA_PATH_PREFIX}update.DeviceGroupPayloadHandler::handleRequest`,
      //TODO: Update this if any changes are made to the lambda handler path
      memorySize: LAMBDA_MEMORY_SIZE_KB,
      role: this.role,
      environment: {
    ...
    const failUpdateStatusStateLambda = new Function(this, 'FailUpdateStatusLambda', {
      //TODO: Update this if any changes are made to the lambda handler path or asset built jar location
      code: Code.fromAsset(`${LAMBDA_ASSET_PATH_TO_DEVICE_MANAGEMENT}`),
      description: 'Lambda responsible for marking as failed',
      runtime: LAMBDA_RUNTIME,
      handler:
        `${DM_WORKFLOW_JAVA_PATH_PREFIX}update.FailUpdateStatusStateHandler::handleRequest`,
      //TODO: Update this if any changes are made to the lambda handler path
      memorySize: LAMBDA_MEMORY_SIZE_KB,
      role: this.role,
      environment: {
    ...
    const determineUpdateTypeState = new LambdaInvoke(this, 'DetermineUpdateType', {
    ...
    const commandCondition = Condition.stringEquals(`${IS_COMMAND_PATH}.Payload`, 'COMMAND');

    const determineCommandTypeState = new LambdaInvoke(this, 'DetermineCommandType', {
    ...
    const createCommandIotJobState = new LambdaInvoke(this, 'CreateCommandIotJob', {
    ...
    const createDownloadFileIotJobState = new LambdaInvoke(this, 'CreateDownloadFileIotJob', {
    ...
    const checkIotDownloadJobStatusState = new LambdaInvoke(this, 'CheckIotDownloadJobStatus', {
    ...
    const determineDeviceState = new LambdaInvoke(this, 'determineDeviceState', {
    ...
    const enabledCondition = Condition.stringEquals(`${IS_REGISTERED_PATH}.Payload`, 'ENABLED');
    const disabledCondition = Condition.stringEquals(`${IS_REGISTERED_PATH}.Payload`, 'DISABLED');
    const createdCondition = Condition.stringEquals(`${IS_REGISTERED_PATH}.Payload`, 'CREATED');

    const createKVSStreamLambdaState = new LambdaInvoke(this, 'CreateKVSStream', {
    ...
    const attachKvsAccessToCertLambdaState = new LambdaInvoke(this, 'AttachKvsAccessToCert', {
    ...
    const detachKvsAccessToCertLambdaState = new LambdaInvoke(this, 'DetachKvsAccessToCert', {
    ...
    const fvlWorkflowCheckerLambdaState = new LambdaInvoke(this, 'FvlWorkflowChecker', {
    ...
    const updateUpdateStatusState = new LambdaInvoke(this, 'UpdateUpdateStatus', {
    ...
    const publishUpdateStatusState = new LambdaInvoke(this, 'PublishUpdateStatus', {
    ...
    createInstallApplicationIotJobState.next(checkIotInstallApplicationJobStatusState);
     ...
     */
    const deviceUpdateStateMachine = new StateMachine(this, 'StartUpdateDeviceStateMachine', {
