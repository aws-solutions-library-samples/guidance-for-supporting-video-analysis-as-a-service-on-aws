...
import { ManagedPolicy, PolicyStatement, Role, ServicePrincipal, CfnRole } from 'aws-cdk-lib/aws-iam';
...
export class DeviceManagementBootstrapStack extends Stack {
    constructor(scope: Construct, id: string, props: DeviceManagementBootstrapStackProps) {
        ...
        const deviceKvsRole = new CfnRole(this, 'DeviceKVSRole', {
          ...
          if (deviceKvsRole == null) {
            throw new Error(`A combination of conditions caused 'deviceKvsRole' to be undefined. Fixit.`);
          }
          const deviceKvsRoleAlias = new iot.CfnRoleAlias(this, 'DeviceKVSRoleAlias', {
                  ...
                  Statement: [
                    {
                      Effect: 'Allow',
                      Action: ['s3:GetObject'],
                      Resource: [`arn:aws:s3:::video-analytics-firmware-bucket-${this.account}-${this.region}/*`],
                    },
                  ],
                },
              },
          ...
          if (deviceS3Role == null) {
            throw new Error(`A combination of conditions caused 'deviceS3Role' to be undefined. Fixit.`);
          }
        ...
        const permissionToPublishToSnsRole = new CfnRole(this, 'PermissionToPublishToSNSRole', {
            ...
            policies: [
              {
                ...
                policyDocument: {
                  ...
                  Statement: [
                    ...
                    {
                      Effect: 'Allow',
                      Action: ['kms:Decrypt', 'kms:Generate*', 'kms:DescribeKey', 'kms:Encrypt', 'kms:ReEncrypt*'],
                      Resource: [
          ...
          if (deviceKvsRoleAlias == null) {
            throw new Error(`A combination of conditions caused 'deviceKvsRoleAlias' to be undefined. Fixit.`);
          }
              ...
              Statement: [
                {
                  ...
                  Resource: [deviceKvsRoleAlias.attrRoleAliasArn, deviceS3RoleAlias.attrRoleAliasArn],
                },
                {
                  Effect: 'Allow',
                  Action: ['iot:Publish'],
